...
## 演示下载和使用提示
（1）. 你可以直接点击下载(http://barcode4j.sourceforge.net/)或者在当前页面点击Clone or download按钮（绿色按钮），然后点击Download ZIP即可将演示应用（目前只提供Android版本）下载到本地，解压即可看到演示应用和相关资料。<br>
...
请下载(http://barcode4j.sourceforge.net/)并安装演示应用来体验吧。<br><br>
